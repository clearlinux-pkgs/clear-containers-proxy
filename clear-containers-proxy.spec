...
Version  : 3.0.6
Release  : 12
URL      : https://github.com/clearcontainers/proxy/archive/3.0.6.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.6.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1509590721
