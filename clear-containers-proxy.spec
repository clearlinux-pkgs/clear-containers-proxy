...
Version  : 3.0.17
Release  : 23
URL      : https://github.com/clearcontainers/proxy/archive/3.0.17.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.17.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1518052291
