...
Version  : 3.0.18
Release  : 24
URL      : https://github.com/clearcontainers/proxy/archive/3.0.18.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.18.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1518648831
