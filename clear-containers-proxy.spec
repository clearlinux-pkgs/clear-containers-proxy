...
Version  : 3.0.20
Release  : 26
URL      : https://github.com/clearcontainers/proxy/archive/3.0.20.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.20.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1519922663
