...
Version  : 3.0.7
Release  : 13
URL      : https://github.com/clearcontainers/proxy/archive/3.0.7.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1510243699
