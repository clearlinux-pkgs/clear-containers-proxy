...
Version  : 3.0.19
Release  : 25
URL      : https://github.com/clearcontainers/proxy/archive/3.0.19.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.19.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1519325604
