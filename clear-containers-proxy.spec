...
Version  : 3.0.15
Release  : 20
URL      : https://github.com/clearcontainers/proxy/archive/3.0.15.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.15.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1516827323
