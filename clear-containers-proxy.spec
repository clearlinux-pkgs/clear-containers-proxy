...
Version  : 3.0.10
Release  : 15
URL      : https://github.com/clearcontainers/proxy/archive/3.0.10.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.10.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1512776931
