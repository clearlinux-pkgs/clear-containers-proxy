...
Version  : 3.0.14
Release  : 19
URL      : https://github.com/clearcontainers/proxy/archive/3.0.14.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.14.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1516361576
