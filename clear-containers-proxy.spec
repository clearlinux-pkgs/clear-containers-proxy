...
Version  : 3.0.3
Release  : 8
URL      : https://github.com/clearcontainers/proxy/archive/3.0.3.tar.gz
Source0  : https://github.com/clearcontainers/proxy/archive/3.0.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1507938797
